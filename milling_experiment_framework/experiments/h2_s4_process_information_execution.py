...
class H2S4ProcessInformationExecution(BaseH2Execution):
    """Run H2.S4 process-information combination experiment."""

    _scenario_id = "S4"
    _experiment_topic = "process_information_combination_all_sensors_all_features_segment_aware_VB_prediction"
    _index_name = "H2_S4_process_information_combination_effect_on_segment_aware_VB_prediction"
