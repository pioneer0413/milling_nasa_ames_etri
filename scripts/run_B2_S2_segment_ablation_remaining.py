...
피처: Delta+Meta (AC+vT+vS, mask=13, 15-dim) — B2_S1과 동일 파이프라인.
...
# B2_S1 reference (idx_start-independent, reliable)
REF_FULL = {"FeatGRU": 0.095122, "FeatLSTM": 0.092217, "XGBoost": 0.113742, "RandomForest": 0.127747}
REF_EXCL_EXIT = {"FeatGRU": 0.109065, "FeatLSTM": 0.097715, "XGBoost": 0.108016, "RandomForest": 0.124424}
