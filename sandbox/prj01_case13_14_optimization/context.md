...
`leaderboards/h4/per_case/top5.csv` 확인. Case 13/14의 기존 상위는 전부 **feature_gru, Delta+Meta(27d), 전체 센서**. Case13 best 0.0969(@70%), Case14 best 0.0932(@80%). 모두 0.08 위. → GRU·전체센서 단일 접근의 한계 확인, 다른 모델·feature 축 탐색 필요 판단.
